...
const docTemplate = `{
    ...
    "paths": {
        "/api/browse": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "absolute path to list; defaults to the user home directory",
                        "name": "path",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.BrowseResponse"
                        }
                    },
                    "400": {
        ...
        "/api/export": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "query + output path",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/server.ExportRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.ExportResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/server.SelfCopyRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.SelfCopyResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/field-samples": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "comma-separated list of field names; default: service.name,host.name,SeverityText,log.level,event.category,_source_format",
                        "name": "fields",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "max values per field (default 30)",
                        "name": "cap",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.FilesResponse"
                        }
                    }
                }
            }
        ...
        "/api/files/load-dir": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "directory or zip path",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.LoadDirResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/files/toggle": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "file id + enabled flag",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/server.ToggleRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/server.IDRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/histogram": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "same shape as /api/query; offset and limit are ignored",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.HistogramResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.ModulesResponse"
                        }
                    }
                }
            }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.QueryResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/settings": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "POST only: partial settings patch",
                        "name": "body",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/server.SettingsBody"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.TimeRangeResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/api/timestamp-field": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "POST only: requested column",
                        "name": "body",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/server.TimestampFieldRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/server.TimestampFieldResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "server.BrowseResponse": {
            ...
            "properties": {
                ...
                "entries": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/server.BrowseEntry"
                    }
                },
                "in_zip": {
                    "type": "boolean"
        ...
        "server.FilesResponse": {
            "type": "object",
            "properties": {
                "files": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/server.FileInfo"
                    }
                },
                "timestamp_field": {
                    "type": "string"
        ...
        "server.HistogramBucket": {
            ...
            "properties": {
                ...
                "start": {
                    "description": "Start is the bucket's first instant, ISO-8601 UTC.",
                    "type": "string"
                }
            }
        },
        "server.HistogramResponse": {
            "type": "object",
            "properties": {
                "buckets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/server.HistogramBucket"
                    }
                },
                "field": {
                    "description": "Field is the timestamp column the buckets were built on.",
                    "type": "string",
                    "example": "@timestamp"
                },
                "interval_seconds": {
                    "description": "IntervalSeconds is the bucket width chosen for this span.",
                    "type": "integer",
                    "example": 300
                },
                "max": {
                ...
                "min": {
                    "description": "Min and Max bound the buckets, so a drag-select can map a pixel\nback to an instant without re-deriving the range.",
                    "type": "string"
                },
                "total": {
                    "description": "Total sums the buckets. Lower than the query's total_count by\nhowever many matching records have no usable timestamp.",
                    "type": "integer"
                }
            }
        },
        ...
        "server.UpdateResponse": {
            ...
            "properties": {
                "available": {
                    "description": "Available is true only when latest is confidently newer.",
                    "type": "boolean"
                },
                "checked": {
                    "description": "Checked is false until a check completes, so \"unknown\" is\ndistinguishable from \"up to date\".",
                    "type": "boolean"
                },
                "current": {
                    "description": "Current is the running version.",
                    "type": "string",
                    "example": "0.1.0"
                },
                "enabled": {
                ...
                "latest": {
                    "description": "Latest is the newest published release, absent if unknown.",
                    "type": "string",
                    "example": "0.2.0"
                },
                "url": {
